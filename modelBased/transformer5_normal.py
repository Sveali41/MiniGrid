...
import os
"""
在copy2的基础上，对每位置增加了postion embedding
...
class ExtractionModule(nn.Module):
    def __init__(self, action_dim, embed_dim, num_heads):
        ...
        self.action_embedding = nn.Linear(action_dim, embed_dim - 3)
    ...
    def forward(self, state, action):
        ...
        action_embed = torch.cat([action_embed, agent_position_embed], dim=-1) # (128, 1, 64)
