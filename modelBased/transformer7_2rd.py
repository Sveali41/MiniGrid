...
import os
"""
在copy5的基础上, 对agent posttion进行重新embeding
...
class ExtractionModule(nn.Module):
    ...
    def forward(self, state, action):
        ...
        agent_position_embed = self.generate_positional_encoding((agent_position[:, 0] * 12 + agent_position[:, 1]).unsqueeze(1), 2).unsqueeze(1)
