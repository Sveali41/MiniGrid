...
def run(cfg: DictConfig):
    ...
    # train the policy of final task in real env & save the model
    ...
    base_model_dir = cfg.PPO.real_policy_path
    ...
    #         policy_file_name = f"PPO_WM_model_{i}.ckpt"
    #         cfg.PPO.policy_file_name = os.path.join(cfg.PPO.real_policy_path, policy_file_name)
